...
Rails.application.config.assets.precompile += %w( website/jquery-1.11.2.js )
Rails.application.config.assets.precompile += %w( website/bootstrap.min.js )
Rails.application.config.assets.precompile += %w( website/plugins.js )
Rails.application.config.assets.precompile += %w( website/main.js )